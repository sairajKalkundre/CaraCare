...
import {Waterbody} from './src/assets/svg/icon';
import AsyncStorage from '@react-native-async-storage/async-storage';
import add from './src/assets/icon/add.png';
import sub from './src/assets/icon/sub.png';
  ...
  const readData = async () => {
    try {
      ...
      if (waterCount !== null) {
       ...
       console.log('Failed to fetch the data from storage',dehydrationcount);
